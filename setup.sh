...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To R32WRTx VPSSTORE TUNNELING SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPS Server On Your Server"
echo -e "  Auther : ${green}RW32RTx VPSSTORE® ${NC}${YELLOW}(${NC} ${green} R32WRTx VPSSTORE ${NC}${YELLOW})${NC}"
